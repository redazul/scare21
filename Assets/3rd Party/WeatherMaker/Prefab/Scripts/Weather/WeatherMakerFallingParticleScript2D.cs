...
namespace DigitalRuby.WeatherMaker
{
    ...
    {
        /// <summary>The starting y offset for particles and mist. This will be offset as a percentage of visible height from the top of the visible world.</summary>
        [Header("2D Settings")]
        ...
        /// <summary>The total width of the particles and mist as a percentage of visible width</summary>
        [Tooltip("The total width of the particles and mist as a percentage of visible width")]
        public float WidthMultiplier = 1.5f;

        /// <summary>Collision mask for the particles</summary>
        [Tooltip("Collision mask for the particles")]
        public LayerMask CollisionMask = -1;

        /// <summary>Lifetime to assign to particles that have collided. 0 for instant death. This can allow the particles to penetrate a little bit beyond the collision point.</summary>
        ...
        /// <summary>When a particles life time is less than or equal to this value, it may emit an explosion</summary>
        ...
        /// <summary>Multiply the velocity of any mist colliding by this amount</summary>
        [Tooltip("Multiply the velocity of any mist colliding by this amount")]
        [Range(0.0f, 1.0f)]
        public float MistCollisionVelocityMultiplier = 0.8f;

        /// <summary>Multiply the life time of any mist colliding by this amount</summary>
