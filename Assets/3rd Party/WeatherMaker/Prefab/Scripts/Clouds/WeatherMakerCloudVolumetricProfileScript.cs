...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerCloudVolumetricProfileScript : ScriptableObject
    {
        ...
        [Header("Clouds - rounding")]
        /// <summary>Cloud bottom fade height end, controls smoothing of bottom of clouds.</summary>
        [MinMaxSlider(0.0f, 0.5f, "Cloud bottom fade height end, controls smoothing of bottom of clouds.")]
        public RangeOfFloats CloudBottomFade = new RangeOfFloats(0.1f, 0.3f);

        /// <summary>Cloud top fade height start, controls smoothing of tops of clouds.</summary>
        [MinMaxSlider(0.5f, 1.0f, "Cloud top fade height start, controls smoothing of tops of clouds.")]
        public RangeOfFloats CloudTopFade = new RangeOfFloats(0.9f, 0.95f);

        /// <summary>Cloud roundness, increases rounding of cloud at higher heights. Lower values round more.</summary>
        [MinMaxSlider(0.0f, 1.0f, "Cloud roundness, increases rounding of cloud at higher heights. Lower values round more.")]
        public RangeOfFloats CloudRoundness = new RangeOfFloats(0.4f, 0.6f);
