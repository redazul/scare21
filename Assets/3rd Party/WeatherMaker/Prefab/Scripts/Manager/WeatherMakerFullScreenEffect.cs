...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerFullScreenEffect : System.IDisposable
    {
        ...
        internal static void DrawMesh(CommandBuffer cmdBuffer, Vector3 objPos, Quaternion objRot, Vector3 objScale, Mesh mesh, Material mat)
        {
            cmdBuffer.DrawMesh(mesh, Matrix4x4.TRS(objPos, objRot, objScale), mat, 0, 0, null);
        }

        internal static void DrawMesh(CommandBuffer cmdBuffer, Transform transform, Mesh mesh, Material mat)
        {
            cmdBuffer.DrawMesh(mesh, transform.localToWorldMatrix, mat, 0, 0, null);
        }
